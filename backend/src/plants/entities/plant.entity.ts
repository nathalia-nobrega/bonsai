...
export class Plant {
   ...
   */
  public static async create(dto: PlantCreationDto): Promise<PlantResponseDto> {
  ...
  public static findAllByUser(userId: string): PlantSummaryDto[] {
    ...
    const plants = Plant.db.data.plants.filter(
