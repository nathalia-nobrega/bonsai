...
export class PlantsController {
    ...
    @ApiResponse({ status: 200, description: 'Plants retrieved successfully', type: [PlantSummaryDto] })
    ...
    @ApiResponse({ status: 200, description: 'Plant found', type: PlantResponseDto })
    ...
    @ApiResponse({ status: 200, description: 'Plant state updated', type: PlantResponseDto })
    @ApiResponse({ status: 404, description: 'Plant not found' })
    @ApiResponse({ status: 400, description: 'Bad request - invalid state data' })
    updateState(@Param('id') id: string, @Body() dto: PlantStateUpdateDto): PlantResponseDto {
